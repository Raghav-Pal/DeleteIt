...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>9c8d1303-78e2-4526-96db-e626351808fd</elementGuidId>
...
WS.verifyElementText(response, 'ListOfCountryNamesByNameResponse.ListOfCountryNamesByNameResult.tCountryCodeAndName[12].sISOCode', 'AR')</verificationScript>
